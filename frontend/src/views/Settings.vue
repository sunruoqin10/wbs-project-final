          ...
          <Card v-if="activeSection === 'profile'">
            ...
            <div class="space-y-6">
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <Select :label="t('settings.profile.role')" v-model="profileForm.role" :disabled="!isAdmin">
...
const handleSyncHr = async () => {
  ...
  try {
    ...
    syncResult.value = {
      success: true,
      message: result.inferred > 0
        ? t('settings.hrSync.syncSuccessWithInference', {
            inserted: result.inserted,
            updated: result.updated,
            resigned: result.resigned,
            inferred: result.inferred,
          })
        : t('settings.hrSync.syncSuccessWithCount', {
            inserted: result.inserted,
            updated: result.updated,
            resigned: result.resigned,
          })
