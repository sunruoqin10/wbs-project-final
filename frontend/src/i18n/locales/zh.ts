export default {
  ...
  team: {
    ...
    allMembers: {
      ...
      filterCompany: '全部公司',
      orgViewTitle: '按组织架构查看',
      searchPlaceholderOrg: '搜索姓名/工号/邮箱',
      loadingOrg: '正在加载组织架构…',
      noMatches: '没有匹配的用户',
      noMembers: '暂无成员',
      loadMore: '加载更多',
  ...
  documents: {
    ...
    previewFailed: '预览失败',
    cannotPreview: '无法预览',
    unsupportedFileType: '此文件类型不支持在线预览',
    pdfPreview: 'PDF预览',
    name: '文档名称',
    namePlaceholder: '留空则使用原文件名',
    category: '分类',
    selectCategory: '选择分类',
    project: '所属项目',
    selectProject: '选择项目',
    uploader: '上传者',
    description: '文档描述',
    descriptionPlaceholder: '文档描述（可选）',
    dragOrClick: '拖拽文件到这里',
    orClickSelect: '或者点击选择文件',
    fileSizeLimit: '支持 PDF、Word、Excel、PPT、图片格式，最大 10MB',
    fileSize: '文件大小',
    createdAt: '创建时间',
    actions: '操作',
    total: '总计',
